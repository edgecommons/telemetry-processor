...
//!
//! The reference Rust **processing** component for the ggcommons / edgecommons ecosystem. It
...
//! standard ggcommons CLI contract (`-c` / `--platform` / `--transport` / `-t`) is parsed by the
//! library. See `docs/TELEMETRY_PROCESSOR.md` in the ggcommons monorepo.
//!
